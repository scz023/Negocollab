...
class HeterNegoInteractTrainFromSingle(nn.Module):
    def __init__(self, args):
        super(HeterNegoInteractTrainFromSingle, self).__init__()
        ...
        for modality_name in self.modality_name_list:
            ...
            setattr(self, f"comm_{modality_name}", ComminPubInteract(model_setting['comm_args']))
