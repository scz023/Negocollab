...
from opencood.models.sub_modules.domian_adapter_mpda import DomianAdapterMpda
...
class HeterMpda(nn.Module):
    def __init__(self, args):
        super(HeterMpda, self).__init__()
        self.args = args
        ...
        for modality_name in self.modality_name_list:
            ...
            setattr(self, f"adapter_{modality_name}", DomianAdapterMpda(adapter_args))
    ...
    def forward(self, data_dict):
        ...
        adapted_heter_feature_2d, da_cls_pred, source_idx \
