...
def getIntermediateheterpaircontrastiveFusionDataset(cls):
    """
    cls: the Basedataset.
    """
    class IntermediatehetercontrastiveFusionDataset(cls):
        ...
        def get_label_item_single_car(self, selected_cav_base, ego_cav_base):
            """
        ...
        def collate_batch_train(self, batch):
            ...
            # record_len_modality = {}
            # for modality_name in self.modality_type_list:
            #     record_len_modality[modality_name] = []
            ...
            for i in range(len(batch)):
                ...
                for modality_name in self.modality_type_list:
                    ...
                    # record_len_modality[modality_name].append(ego_dict['agent_modality_list'].count(modality_name))
                ...
                if self.supervise_single or self.heterogeneous:
                    ...
                    pos_region_ranges_single.append(ego_dict['single_label_dict_torch']['pos_region_ranges'])
            ...
            for modality_name in self.modality_type_list:
                ...
                # record_len_modality[modality_name] = torch.from_numpy(np.array(record_len_modality[modality_name], dtype=int))
            ...
            # label_torch_dict['record_len_modality'] = record_len_modality
            ...
            if self.supervise_single  or self.heterogeneous:
                output_dict['ego'].update({
                    "label_dict_single":{
                            ...
                            "pos_region_ranges": torch.cat(pos_region_ranges_single, dim=0),
    ...
    return IntermediatehetercontrastiveFusionDataset
