...
def getIntermediatehetersubdataFusionDataset(cls):
    """
    cls: the Basedataset.
    """
    class IntermediatehetersubdataFusionDataset(cls):
        ...
        def __getitem__(self, idx):
            ...
            for _i, cav_id in enumerate(cav_id_list):
                ...
                if _i == 0:
                    subdataset_label = selected_cav_base['subdataset_label']
                    subdataset_label_list.append(subdataset_label)
            ...
            # generate single view GT label, reference pose is each cav itself
            if self.supervise_single or self.heterogeneous:
            ...
            processed_data_dict['ego'].update({'agent_modality_list': agent_modality_list,
                                               'subdataset_label_list': subdataset_label_list})
        ...
        def collate_batch_train(self, batch):
            ...
            for i in range(len(batch)):
                ...
                subdataset_label_list.extend(ego_dict['subdataset_label_list'])
        ...
        def collate_batch_test(self, batch):
            ...
            output_dict['ego'].update({
                ...
                "subdataset_label_list": batch[0]['ego']['subdataset_label_list']
    ...
    return IntermediatehetersubdataFusionDataset
