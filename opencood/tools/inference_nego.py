...
def main():
    ...
    if 'm' in opt.collab_mode:
        resume_epoch, model = train_utils.load_modality_saved_model_ap(saved_path, model, opt.collab_mode, \
            True, opt.eval_epoch)
    else:
    ...
    infer_info = opt.collab_mode + '_' + opt.fusion_method + opt.note
